...
public class {pascalname}DBTypeFactory extends DefaultSQLDBTypeFactory {
    ...
    protected {pascalname}DBTypeFactory(Map<String, DBTermType> typeMap, ImmutableMap<DefaultTypeCode, String> defaultTypeCodeMap) {
        super(typeMap, defaultTypeCodeMap);
    }
    @AssistedInject
    protected {pascalname}DBTypeFactory(@Assisted TermType rootTermType, @Assisted TypeFactory typeFactory) {
        super(create{pascalname}TypeMap(rootTermType, typeFactory), create{pascalname}CodeMap());
    }

    protected static Map<String, DBTermType> create{pascalname}TypeMap(TermType rootTermType, TypeFactory typeFactory) {
    ...
    protected static ImmutableMap<DefaultTypeCode, String> create{pascalname}CodeMap() {
