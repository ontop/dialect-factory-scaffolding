...
public class {pascalname}DBFunctionSymbolFactory extends AbstractSQLDBFunctionSymbolFactory {

    @Inject
    protected {pascalname}DBFunctionSymbolFactory(TypeFactory typeFactory) {
        super(create{pascalname}RegularFunctionTable(typeFactory), typeFactory);
    }

    protected static ImmutableTable<String, Integer, DBFunctionSymbol> create{pascalname}RegularFunctionTable(
